...
$notes_sql = "SELECT id, title, content, attachment_url ,created_at, subject, fee FROM notes WHERE user_id = ?";
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="settings.php">Profile Settings</a></li>
...
<div class="container">
    ...
    <?php while ($note = $notes_result->fetch_assoc()) { ?>
        <tr>
            ...
            <td>
                <a href="viewNotesForTeacher.php?id=<?php echo $note['id']; ?>" class="btn btn-info btn-sm" target="_blank">
                    View
                </a>
            </td>
        ...
        <tbody>
            <?php while ($answer = $answers_result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="viewAnswerAttachment.php?id=<?php echo $answer['id']; ?>" class="btn btn-info btn-sm" target="_blank">
                            View
                        </a>
                    </td>
                </tr>
        ...
        <tbody>
            <?php while ($book_guide = $book_guides_result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                <a href="viewGuideForTeacher.php?id=<?php echo $book_guide['id']; ?>" class="btn btn-info btn-sm" target="_blank">
                    View
                </a>
            </td>
                </tr>
